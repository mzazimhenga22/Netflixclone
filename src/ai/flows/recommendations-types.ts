// File: ai/flows/recommendations-types.ts
...
// --- NEW EXPORT -------------------------------------------------------------
// Export a concrete type for a single recommendation row so callers won't get implicit `any`.
export type RecommendationCategory = z.infer<typeof RecommendationCategorySchema>;




// (optional) re-export the list of valid genres if needed by consumers
export const ALL_RECOMMENDABLE_GENRES = allGenres;